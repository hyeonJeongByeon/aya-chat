/* AYA-CHAT Clover — content bank v3 (participant interviews)
   Sources: updated-intervention-content.docx + updated-chatbot-engagement.docx (7.27)
...
window.CLOVER3 = (function () {
  ...
  const moodFollowNeg = [
    ...
    "Is there anything you can think of to try that could help?",
  ...
  const funFacts = [
    ...
    { d: 6, type: "t", q: "🤔 True or False: It is physically impossible to hum while holding your nose.",
      a: "Answer: TRUE! You tried it, didn't you? We caught you. 😂" },
  ...
  /* Fun-fact openers, led by today's mood valence */
  const funFactOpeners = {
    neg: [
      "Sometimes it helps to shift gears a little bit. Here's something random that might make you smile. 😊",
      "Here's an interesting fun fact that might get your mind off things for a second",
      "Sometimes it helps to take a breather, so on a separate note, here's something you might find fun.",
      "Here's something interesting in case your brain wants to take a break.",
      "Sometimes a small change of pace can be nice. Here's a fun fact that might brighten your day a little.",
      "Here is a light fun fact to brighten your mood.",
      "Sometimes a tiny mental reset can be helpful. Here's a fun fact for a quick reset."
    ],
    neu: [
      "Sometimes learning about something new is a nice reminder that the world is full of interesting little surprises. Here's one for you.",
      "Every now and then, it's fun to discover something new. Here's a fun fact for you.",
      "Discovering something you didn't know before can be a welcome change in perspective. Here's one for you.",
      "The world is full of fascinating little details. Here's one for you.",
      "New insights remind us that life is constantly changing and growing. Here's a fun fact for you",
      "A little moment of curiosity is always a welcome break in the day. Here's a fun fact for you",
      "There's no shortage of interesting things to discover. Here's one for you."
    ],
    pos: [
      "Great to hear! Here's something you might find interesting to match that upbeat energy!",
      "Love to hear! Here's a fun fact to keep those good vibes going",
      "Glad the day is treating you well, here's a little something to keep you smiling 😊",
      "So happy to hear that! Here's a fun fact to top it off",
      "Love that energy! Here's something new to keep the good momentum rolling!",
      "Let's celebrate those good vibes with something fascinating 🎉",
      "Hope this adds a little extra spark to your day. Here's a fun fact for you."
    ]
  };
  ...
  /* ============ Onboarding options ============ */
  const interestNoneAck = "No problem, thanks for letting me know.";
  ...
  const baGeneric = [
    { ch: "Daily challenge: Spend some time doing something you love, not because it is productive, but because you enjoy it ❤️. I'll check back in to see your progress tomorrow 🤗.",
      checkin: "What was the thing you love that you ended up doing? What makes you enjoy it? ❤️",
    ...
    { ch: "Daily challenge: Send someone a song that reminds you of them 🎶. I'm going to check back in tomorrow to see how you did 😊",
    ...
    { ch: "Daily challenge: Play a fun game you haven't touched in a while 🕹️🧩🎲. Tomorrow, I'd love to hear how it went. ☺️",
      checkin: "Did you dust off an old favorite game? How was it going back to something familiar? 🕹️🧩🎲",
    ...
    { ch: "Daily challenge: Give yourself a genuine compliment today — reflect on something you're proud of 💛. I'd love to hear about how this went tomorrow. 😌",
    ...
    { ch: "Daily challenge: Make your favorite snack or meal today and take your time enjoying the process 🍳. I'll check in tomorrow to see how it went. 😊",
      checkin: "What favorite food did you make? How did it turn out? 🍳",
      done: "Taking some me-time to prepare and eat something you enjoy, that's a win",
      notDone: "That meal will still be waiting for when you and your stomach are ready" },
    { ch: "Daily challenge: Make a playlist with a theme — late night drive, rainy day, movie montage, anything 🚗. I'm excited to hear about how it goes tomorrow 😁.",
    ...
    { ch: "Daily challenge: Make a list of your \"favorites\": could be favorite songs, places, people, meals, memories, games, moments in your day 📄. I'm looking forward to hearing about the list tomorrow! 😊",
    ...
    { ch: "Daily challenge: Step outside and see if you can spot three different plants, birds, or insects, and find out what they are online. 🐦🐜🌺 I'll check back in to see what you found tomorrow 🤗.",
    ...
    { ch: "Daily challenge: Open your camera roll and favorite 5 photos that make you happy 📸 Tomorrow, I'd love to hear about the pictures you chose 🤗",
    ...
    { ch: "Daily challenge: Spend 5 minutes sitting somewhere that makes you feel peaceful and calm and enjoy a quiet moment 🌤️. I'll check in tomorrow to see how it went ☺️",
      checkin: "How did the quiet moment sitting somewhere peaceful go? 🌤️",
    ...
    { ch: "Daily challenge: Reach out to a friend who shares some of the same interests and make plans to hang out! 📲 I'm excited to hear about how it goes tomorrow 😁",
    ...
    { ch: "Daily challenge: Leave a kind note to yourself, somewhere you'll see later 💌. I'm going to check back in tomorrow to see how you did 😊",
    ...
    { ch: "Daily challenge: Take a walk listening to your top three songs of the week 🎧 I can't wait to hear about your favorite songs tomorrow 😊",
    ...
    { ch: "Daily challenge: Make a small \"try later\" list — a café, recipe, event, or new experience 🌱. I'm looking forward to hearing about your list tomorrow 😌",
    ...
    { ch: "Daily challenge: Pick a small task you've been avoiding for a while and just get started on it. No pressure to finishing it. 🏁 I'll check back in to see your progress tomorrow 🤗",
    ...
    { ch: "Daily challenge: Spend some time tidying your room ✨ I'll check in with you tomorrow to see how it went 😊",
    ...
    { ch: "Daily Challenge: look up something that you've been really curious about 💻 I'll check in tomorrow, I'm curious to hear about what you find interesting 🤓",
    ...
    { ch: "Daily challenge: Treat yourself with your favorite meal today 🍴 I'm going to check in tomorrow to hear how it went 😌",
    ...
    { ch: "Daily challenge: Go somewhere nearby you've never actually taken time to explore 🚶 Tomorrow I'd love to hear about how this went 😊",
    ...
    { ch: "Daily challenge: Send someone a meme that you thought was funny 😂 I'm excited to hear about this goes ☺️",
    ...
    { ch: "Daily challenge: Reach out and make plans with someone this weekend. 📅 I'm going to check back in tomorrow to see how it went 😁",
    ...
    { ch: "Daily challenge: Rewatch a favorite movie or episode that always makes you smile 🍿 Tomorrow, I'd love to hear more about what you watched 🤗",
    ...
    { ch: "Daily challenge: Organize one thing. It could be a drawer, your desk, or your phone home screen. Small wins count! ⭐️ I'll check in to see your progress tomorrow 😊",
      checkin: "What'd you get organized? Does it feel better to have it out of the way? ⭐️",
    ...
    { ch: "Daily challenge: Try something new - it could be food, a coffee shop or restaurant, an activity. 🎉 I'm excited to find out what you tried tomorrow 😁",
    ...
    { ch: "Daily challenge: Text someone you've been meaning to catch up with 👋 I'll check in tomorrow to see how this went 😌",
    ...
    { ch: "Daily challenge: Make something small - a doodle, a playlist, a simple snack, anything. Just create for a few minutes 🎨 Tomorrow, I would love to hear about what you created ☺️",
    ...
    { ch: "Daily challenge: Listen to one song you've never heard before. Any genre, any era 🎧 I'm looking forward to hearing about what you listened to tomorrow 😆",
  ...
  const baTailored = {
    "Sports": { ch: "Daily challenge: Watch a game of your favorite team, watch some highlights, or if you're able to, bust out some of your favorite athletes most iconic moves ⛹️ Tomorrow, I'd love to hear how it went 😁",
    ...
    "Reading": { ch: "Daily challenge: Read a chapter of the book you're into right now — and if you're between books, spend a few minutes googling your next read. 📚 I'm going to check back in tomorrow to see how you did 😌",
    ...
    "Baking": { ch: "Daily Challenge: Bake something today — even if it's just box brownies, bonus points if it's something new. 🎂 I'm looking forward to hearing about what you baked 🧁",
    ...
    "TV": { ch: "Daily Challenge: Watch an episode of your current show or rewatch something you already love. If you're rewatching, keep track of how much dialogue you can quote. 🎥🎬 I'd love to hear about what you watched tomorrow 😊",
    ...
    "Video games": { ch: "Daily Challenge: Play a level, get a win, finish a quest, or boot up a favorite game you haven't touched in a while and see how you left off 🎮 I'll check back in on your progress tomorrow ☺️",
    ...
    "Fashion": { ch: "Daily challenge: Put together an outfit that makes you feel good, and wear it. 👗 Can't wait to find out what you put together 😊",
    ...
    "Writing/journaling": { ch: "Daily challenge: Write a couple sentences — journal entry, short story, haiku, even a random thought that lives rent free in your head. Just get it onto a page. 📝 I'll check back in to see your progress tomorrow 😌",
    ...
    "Photography": { ch: "Daily Challenge: Take a few pictures of anything that catches your eye, let's see if you find something beautiful! 📸 Tomorrow, I'd love to hear about what you captured 🙃",
    ...
    "Podcasts": { ch: "Daily Challenge: put on an episode of your favorite podcast that's really calling your name and let it play while life happens around you 🎧 I'm looking forward to hearing about what you listened to tomorrow 😆",
    ...
    "Playing Musical Instruments": { ch: "Daily challenge: pick up your instrument of choice and jam a little bit, see if you can put together a sick melody 🎶🎹 Tomorrow, I'd love to hear about your jam sesh ☺️",
    ...
    "Plants": { ch: "Daily Challenge: check in on your plant today — let's make sure it's still thriving, water it, open a window, re-pot it, whatever it needs 🌻 I'm going to check back in to see your progress tomorrow 😊",
    ...
    "Makeup/Beauty": { ch: "Daily challenge: Do your makeup or skin care routine today in a way that makes you feel confident, not for any reason — just for you 💄 I'm excited to hear about how it goes tomorrow 🙃",
    ...
    "Fitness": { ch: "Daily challenge: Move your body in a way that makes you feel great — workout, yoga, even a walk, anything counts 🤸‍♂️ Tomorrow, I'd love to hear about how it went 😋",
  ...
  const savoring = [
    ...
    { week: 1, n: 2,
      def: [
        "Picture three good things that could realistically happen tomorrow. They can be small, like enjoying your favorite food or hanging out with friends, or bigger, like feeling proud of yourself for finishing something important. 🖼️",
        { pause: 10 },
    ...
    { week: 3, n: 1,
      def: [
        { ask: "What's one small adventure you could have tomorrow? It could be trying something new, enjoying a favorite snack, taking a walk, or having a meaningful conversation. ⛰️" },
  ...
  const mindfulnessPre = "Let's take a short mindfulness break with Clover's helper, {NAME}. This exercise will take about 2 minutes. Just press play whenever you're ready! If you'd prefer a text version of today's mindfulness exercise, let me know.";

  const mindfulness = [
    { week: 1, n: 1, title: "Breath as My Home Base", audioKey: "mf-w1-1",
      green: "✨ Thank you for giving yourself this mindful moment. Remember, your breath is always there as a steady place to return to whenever you need a moment of gentle calm.",
      text: [
    ...
    { week: 1, n: 2, title: "Sending Kindness to a Loved One", audioKey: "mf-w1-2",
      green: "✨ Thank you for practicing kindness today. Even a few moments of wishing someone well can nurture warmth in both your heart and theirs.",
      text: [
    ...
    { week: 2, n: 1, title: "A Short Body Scan", audioKey: "mf-w2-1",
      green: "✨ Thank you for taking the time to pause and check in with yourself.",
      text: [
    ...
    { week: 2, n: 2, title: "Exploring Thoughts and Feelings", audioKey: "mf-w2-2",
      green: "✨ Great job! Paying attention to these sensations can help you feel more aware and mindful of the present.",
      text: [
    ...
    { week: 3, n: 1, title: "Returning to Your Breath in Sound, Body, and Feelings", audioKey: "mf-w3-1",
      green: "✨ Slowing down and focusing on your breath can help your body and mind reset. Giving yourself even a small moment to breathe is an act of care.",
      text: [
    ...
    { week: 3, n: 2, title: "Holding on to Multiple Feelings", audioKey: "mf-w3-2",
      green: "✨ Nice work making space for all of your feelings today! By noticing both comfort and difficulty without judgment, you're practicing balance and self-care.",
      text: [
    ...
    { week: 4, n: 1, title: "Kindness During Difficult Moments", audioKey: "mf-w4-1",
      green: "✨ Thank you for offering kindness to yourself in this moment.",
      text: [
  ...
  const mbscPre = "Let's take a short mindfulness break with Clover's helper, {NAME}. This exercise will take about 2 minutes. Just press play whenever you're ready! If you'd prefer a text version of today's mindfulness exercise, let me know.";
